...
setup() {
	...
	# 0=Download the porn package from this repo
	# 1=Unpack the downloaded porn_package zip
	# 2=Check if the porn package is in the target file and export the true-false boolean to a file.#FILEPATH_DUMMY_HOST
	...
	# 6=Export the remaining lines of the target file after the lines uptill the start line of porn package are removed.#FILEPATH_DUMMY_HOST
	...
	# 8=Outputs the absolute line end nr of the porn package in the original host file.#FILEPATH_DUMMY_HOST
	# 9=Export a boolean indicating whether the modified porn package is contained.
	# 10=If modified porn package is found in the input  path, remove it.#FILEPATH_DUMMY_HOST
	# 11=Appends the new porn pack if the unmodified porn package is not yet included.#FILEPATH_DUMMY_HOST
	...
	declare -a additional_arguments=(
		"test/testfiles/dummy_hostfile_with_porn_pack.txt"
	)
