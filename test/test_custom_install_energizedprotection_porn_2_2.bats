...
setup() {
	...
	declare -a additional_arguments=(
		"test/testfiles/hostfile_with_porn_pack.txt"
	)
...
@test "Tests whether the function that checks if the social package is contained in an target/input file returns true if an input file with social package is fed." {
	...
	# Assert the the function that checks if the social package is contained in an target/input file returns true if an input file withsocial package is fed.
	assert_equal "$ACTUAL_RESULT" "true"
}