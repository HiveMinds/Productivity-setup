...
setup() {
	...
	# 2=Check if the social package is in the target file and export the true-false boolean to a file.#FILEPATH_DUMMY_HOST
	...
	# 6=Export the remaining lines of the target file after the lines uptill the start line of social package are removed.#FILEPATH_DUMMY_HOST
	...
	# 8=Outputs the absolute line end nr of the social package in the original host file.#FILEPATH_DUMMY_HOST
	# 9=Export a boolean indicating whether the modified social package is contained.
	# 10=If modified social package is found in the input  path, remove it.#FILEPATH_DUMMY_HOST
	# 11=Appends the new social pack if the unmodified social package is not yet included.#FILEPATH_DUMMY_HOST
...
#---------------------------------------------------------------------------------------------------------------------------
@test "Tests if 11 keeps an unmodified file if the social package was already included." {
	...
	# The function should have kept the file unchanged because it already contained the unmodified social package. Hence
	# a hostfile with social package is expected.
