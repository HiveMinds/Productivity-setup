...
setup() {
	...
	declare -a additional_arguments=(
		"test/testfiles/dummy_hostfile_with_modified_social_pack.txt"
	)
...
@test "Tests if 10 removes the modified social package." {
	...
	md5_of_actual_target_after_social_package_removal=$(sudo md5sum "test/testfiles/dummy_hostfile_with_modified_social_pack.txt")
	...
	EXPECTED_TARGET_FILEPATH="test/testfiles/hostfile_with_modified_social_pack_removed.txt"
