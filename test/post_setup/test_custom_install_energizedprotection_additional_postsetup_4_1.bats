...
@test "Tests whether an exception is thrown when computing the total nr of lines, if the file is not found ERRROR." {
	...
	run install_energized_protection_additional_package "custom_install_4_energizedprotection" "test/testfiles/nonexistant_filename.txt"
	
	# The test fails if the assert failure directly follows this (working) command. 
	#run install_energized_protection_additional_package "custom_install_4_energizedprotection" "test/testfiles/hostfile_with_social_pack.txt"
