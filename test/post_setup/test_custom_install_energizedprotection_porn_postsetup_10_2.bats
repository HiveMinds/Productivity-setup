...
#	md5_of_actual_target_after_social_package_removal=$(sudo md5sum "test/testfiles/dummy_hostfile_with_modified_porn_pack.txt")
#	
...
#	EXPECTED_TARGET_FILEPATH="test/testfiles/hostfile_with_modified_porn_pack_removed.txt"
#	
